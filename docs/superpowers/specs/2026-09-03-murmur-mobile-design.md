...
murmur/
  ...
  apple/
    project.yml             # XcodeGen source of truth for Murmur.xcodeproj (app, MurmurKeyboard, MurmurTests, MurmurKeyboardTests)
    Murmur.xcodeproj        # generated by `xcodegen generate`, committed
...
### 6.4 Project wiring
- `apple/Murmur.xcodeproj` is generated from `apple/project.yml` by XcodeGen (the yml is the
  source of truth; both are committed, nobody hand-edits the pbxproj). Target `MurmurKeyboard` is an app extension
