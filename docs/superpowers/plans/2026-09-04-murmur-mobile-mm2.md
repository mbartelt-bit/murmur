...
## Task 1 — Keyboard logic package: layout model + handoff controller (no UI)
...
## Task 2 — The keyboard extension target and UI
...
## Task 3 — App Intent, App Shortcuts, Control Center control
...
## Task 4 — Onboarding steps for the keyboard and triggers; Home status
...
## Task 5 — Crash safety: finish the last dictation
...
## Task 6 — Device gates, signing, TestFlight
